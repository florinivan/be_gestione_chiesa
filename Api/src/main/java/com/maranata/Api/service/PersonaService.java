...
public class PersonaService {
    ...
    public ResponseEntity<PersonaDto> personaAdd(PersonaDto personaDto) {
        return personaFeignClient.personaAdd(personaDto);
    }

    public ResponseEntity<PersonaDto> personaUpdate(PersonaDto personaDto, Long id) {
        return personaFeignClient.personaUpdate(personaDto,id);
    }

    public ResponseEntity<PersonaDto> coniugeAdd(ConiugeDto coniugeDto){
